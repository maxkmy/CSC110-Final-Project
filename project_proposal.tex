...
\section*{Computational Plan}
    ...
    \begin{enumerate}
        ...
        \item Extract necessary fields from each CSV file and assign them to appropriate country's instance attributes.
    ...
    \begin{enumerate}
        ...
        \item \textbf{Aggregate Sector GDP as a \% of Aggregate GDP Grouped by National Income Quartile}
            \begin{enumerate}[(a)]
                ...
                \item \textbf{Visualization}: Generate a bar chart using \texttt{Plotly} for the four sectors (from dataset). For each sector, plot sector GDP as a \% of aggregate GDP for each income quartile.
            \end{enumerate}
